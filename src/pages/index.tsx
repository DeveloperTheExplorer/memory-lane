  ...
  return (
    <ErrorBoundary>
      <Head>
        ...
        <meta
          name="description"
          content="Create and explore your personal collection of timelines and cherished memories. Organize your life's moments in a beautiful, chronological way."
        />
        <meta property="og:title" content="Memory Lane - Your Personal Collection of Timelines" />
        <meta
